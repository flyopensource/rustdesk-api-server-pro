...
type Device struct {
	...
	Platform                string    `xorm:"'platform' varchar(32)"`
	Arch                    string    `xorm:"'arch' varchar(32)"`
	...
	PermanentPasswordSet    bool      `xorm:"'permanent_password_set' tinyint"`
	PasswordError           string    `xorm:"'password_error' varchar(255)"`
	PasswordReportedAt      time.Time `xorm:"'password_reported_at' datetime"`
